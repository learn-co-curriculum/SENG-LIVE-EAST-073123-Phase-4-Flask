...
class User(db.Model, SerializerMixin):
    ...
    def password_hash(self):
     ...
     # 6.✅ Create a setter method called password_hash that takes self and a password.
        #6.1 Use bcyrpt to generate the password hash with bcrypt.generate_password_hash
        #6.2 Set the _password_hash to the hashed password
